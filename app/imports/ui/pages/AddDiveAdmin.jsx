                        ...
                        <Card.Group className="card-group">
                            <Card className="initial-dive-card" centered>
                                ...
                                <Container style={{padding: 20}}>
                                    <Form>
                                        <h2 style={{fontSize: 14}}>Starting Diving Pressure Group</h2>
                                        <Form.Dropdown
                                            fluid
                                            search
                                            selection
                            ...
                            <Card style={{padding: 20}} centered>
                                ...
                                <i>Note: If Final Diving Pressure Group does not show anything, refer to the PADI Table. Your
